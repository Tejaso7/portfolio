  ...
  return (
    ...
    <div>
      <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-center mb-10">
        ...
        <p className="text-lg sm:text-xl font-semibold tracking-tight text-center mb-10">We're proud to work with industry leaders across various sectors to deliver exceptional results.</p>
    </div>
      <div
      ref={containerRef}
      className={cn(
